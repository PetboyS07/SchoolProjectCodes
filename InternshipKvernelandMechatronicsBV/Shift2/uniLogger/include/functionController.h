...
public:
    ...
    InitParameters initParameters; // Params to initialize camera.
    RuntimeParameters runtimeParameters; // Params to initialize video.
    PositionalTrackingParameters trackingParameters; // Params to initialize positional tracking.
    SpatialMappingParameters mappingParameters; // Params to initialize spatial mapping
    Pose zedPose; // create position from Pose class

    // for recording svo
    RecordingParameters recordingParameters; // Params to initialize recording.
