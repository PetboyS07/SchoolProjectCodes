...
{
  Log() << "[cameraGrabber::runGrabThread] Start grab...\n";
  ...
  while(runThread)
  {
    ...
    {
      runThread = false;            
      Log() << "[cameraGrabber::runGrabThread] No Pointcloud, runThread = false;\n";
    }
  ...
  Log() << "[cameraGrabber::runGrabThread] Stop grab...\n";
}
...
{
  Log() << "[CameraGrabber::transformPointcloud] start transforming pointcloud.\n";
  ...
  {
    Log() << "[CameraGrabber::transformPointcloud] No pointcloud to transform.\n";
    return false;
  }
  ...
  Log() << "[CameraGrabber::transformPointcloud] adjusting...\n";
...
{
  Log() << "[CameraGrabber::transformPointcloud] Pushing data...\n";
