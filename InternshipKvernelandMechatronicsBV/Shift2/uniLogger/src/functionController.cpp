...
{
    cout << endl;
    cout << "[Camera Init] Begin initializing the ZED camera...\n\n";
    int camerares = 0;

    cout << "[Camera Init] Please enter Camera resolution below [1-VGA, 2-HD720, 3-HD1080, 4-HD2K] " << endl;
    cout << "[Camera Init] Camera Resolution [int]: ";
    cin >> camerares;

    switch (camerares)
    {
        case 0:
            cout << "[Camera Init] Set default: 720\n\n";
            initParameters.camera_resolution = sl::RESOLUTION::HD720;
            break;
        
        case 1:
            cout << "[Camera Init] Set resolution to VGA\n\n";
            initParameters.camera_resolution = sl::RESOLUTION::VGA;
            break;

        case 2:
            cout << "[Camera Init] Set resolution to HD720\n\n";
            initParameters.camera_resolution = sl::RESOLUTION::HD720;
            break;

        case 3:
            cout << "[Camera Init] Set resolution to HD1080\n\n";
            initParameters.camera_resolution = sl::RESOLUTION::HD1080;
            break;  

        case 4:
            cout << "[Camera Init] Set resolution to HD2K\n\n";
            initParameters.camera_resolution = sl::RESOLUTION::HD2K;
            break;  

        default:
            cout << "[Camera Init] Invalid resolution\n\n";
            exit(-1);  
    }
