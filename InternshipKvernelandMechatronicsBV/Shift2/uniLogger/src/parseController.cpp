...
bool parseController::argHelp(void)
{
    ...
    cout << "[Parser] Type '-l' or '--logger' + '/path/to/your/svofile/' to start the UniLogger in SVO mode." << endl;
    cout << "[Parser] Type '-l' or '--logger' + '--live' to start the UniLogger in LIVE mode." << endl;
    cout << endl;
...
bool parseController::runFunction(char *argv2)
{
    ...
    if (beginRecord)
    {
        ...
        Log() << "\n[Dummy] in the if statement for beginning the record\n";
    }
    ...
    if (beginPlayback)
    {
        ...
        Log() << "\n[Dummy] in the if statement for beginning the playback\n";
    }
    ...
    if (beginSvoToPcl)
    {
        ...
        Log() << "\n[Dummy] in the if statement for beginning the svotofpcl\n";
    }
    ...
    if (beginSvoToFilteredPcl)
    {
        ...
        Log() << "\n[Dummy] in the if statement for beginning the svotofilteredpcl\n";
    }
    ...
    if (beginTrackPosition)
    {
        ...
        Log() << "\n[Dummy] in the if statement for beginning positional tracking\n";
    }
    ...
    if (beginSpatialMapping)
    {
        ...
        Log() << "\n[Dummy] in the if statement for spatial mapping.\n";
    }
    ...
    if (beginTestWindow)
    {
        ...
        Log() << "\n[Dummy] in the if statement for test window.\n";
    }
    ...
    if (beginPclFilter)
    {
        ...
        Log() << "\n[Dummy] in the if statement for filter pcl.\n";
    }
    ...
    if (beginPclViewer)
    {
        ...
        Log() << "\n[Dummy] in the if statement for view pcl.\n";
    }
    ...
    if (getSerialNumber)
    {
        ...
        Log() << "\n[Dummy] in the if statement for getting serialnumber\n";
    }
    ...
    if (getImage)
    {
        ...
        Log() << "\n[Dummy] in the if statement for getting Image\n";
    }
    ...
    if (getDepth)
    {
        ...
        Log() << "\n[Dummy] in the if statement for getting depth\n";
    }
    ...
    if (getSensordata)
    {
        ...
        Log() << "\n[Dummy] in the if statement for getting sensor data\n";
    }
