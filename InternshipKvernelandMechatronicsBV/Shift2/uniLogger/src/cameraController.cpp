...
bool initCamera(void) 
{
  ...
  int camerares = 0;
  std::cout << "[Camera Init] Please enter Camera resolution below [0-SVO, 1-VGA, 2-HD720, 3-HD1080, 4-HD2K] " << std::endl;
  std::cout << "[Camera Init] Camera Resolution [int]: ";
  std::cin >> camerares;

  switch (camerares)
  {
    case 0:
      std::cout << "[Camera Init] Set to SVO resolution\n\n";
      initParams.camera_resolution = sl::RESOLUTION::HD720;
      break;
        
    case 1:
      std::cout << "[Camera Init] Set resolution to VGA\n\n";
      initParams.camera_resolution = sl::RESOLUTION::VGA;
      break;

    case 2:
      std::cout << "[Camera Init] Set resolution to HD720\n\n";
      initParams.camera_resolution = sl::RESOLUTION::HD720;
      break;

    case 3:
      std::cout << "[Camera Init] Set resolution to HD1080\n\n";
      initParams.camera_resolution = sl::RESOLUTION::HD1080;
      break;  

    case 4:
      std::cout << "[Camera Init] Set resolution to HD2K\n\n";
      initParams.camera_resolution = sl::RESOLUTION::HD2K;
      break;  

    default:
      std::cout << "[Camera Init] Invalid resolution\n\n";
      exit(-1);  
  }
